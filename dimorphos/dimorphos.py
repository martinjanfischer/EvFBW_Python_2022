...
class Dimorphos:
    ...
    def __enter__(self):    # Konstruktor Funktion: Bereite alle Mitglied Variablen und Ressourcen dieser Klasse vor
        ...
        start_ansicht.raumschiffe.append(Raumschiff(Vector2(0, 0), "raumschiff1", [Vector2(-10, -25), Vector2(10, -25)]))
        start_ansicht.raumschiffe.append(Raumschiff(Vector2(0, 0), "raumschiff2", [Vector2(0, -25), Vector2(-20, 0), Vector2(20, 0)]))
        start_ansicht.raumschiffe.append(Raumschiff(Vector2(0, 0), "raumschiff3", [Vector2(-10, -20), Vector2(10, -20), Vector2(-30, 15), Vector2(30, 15)]))
