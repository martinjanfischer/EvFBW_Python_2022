...
class Dimorphos:
    ...
    def __enter__(self):    # Konstruktor Funktion: Bereite alle Mitglied Variablen und Ressourcen dieser Klasse vor
        ...
        level_4.hintergrund = hintergrund_2
        ...
        level_4.bild_explosion = bild_explosion
        ...
        level_4.ton_explosion = ton_explosion
        ...
        level_4.bilder_asteroiden = bilder_asteroiden
        ...
        level_4.bild_mutterschiff = bild_mutterschiff
        ...
        level_4.bild_laser = self.laser_bild
        level_5.bild_laser = self.laser_bild
        karriere_level = [level_1, level_2, level_3, level_4,level_5]
